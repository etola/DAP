...
def load_config(config_path: str | None):
    ...
    with resources.open_text("ddpy_dap.config", "infer.yaml") as f:
        return yaml.load(f, Loader=yaml.FullLoader)
...
def main():
    ...
    parser.add_argument("--config", "-c", default=None, help="Path to inference config, default uses packaged config")
